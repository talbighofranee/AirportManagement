...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
      ...
      // ,
        ...
        public static Flight flight2 = new Flight { FlightDate = new DateTime(2022, 01, 03, 21, 10, 10),AirlineLogo= "abc",Departure = "Tunis",
 Destination = "Paris", EffectiveArrival = new DateTime(2022, 02, 01, 23, 10, 10), EstimatedDuration = 105, Plane = BoingPlane };
